...
public class FlightTest {
    ...
    @Test
    void testConstructorThatTakesDateAndTimeAsOneString(){
        Flight test = new Flight("123","PDx", "SeA", "1/1/2023 10:29 PM", "1/2/2023 10:21 AM");

        assertThat(test.toString(),containsString( "123 "));
    }

    @Test
    void testPutFlightIntoMap()
    {
