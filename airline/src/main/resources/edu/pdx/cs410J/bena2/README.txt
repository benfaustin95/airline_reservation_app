#################################################################################
#              Ben Austin, CS410J-001, 02/08/2023, bena2@pdx.edu                #
#                Program 3: Designing an Airline Application                    #
#################################################################################

Overview:
    Program Three airline-2023.0.0 allows the user to create and print an airline
    ...
    as well as print in an easy-to-read format.
...
Please enter the following to execute the program.
    ...
    Command Line Execution: java -jar target/airline-2023.0.0.jar [options] <arguments>
        ...
        Options (all options are optional and can be provided in any order)
            ...
            -pretty file    -Pretty print the airline's flights to a text file or standard
                             out.
                            -Please note if file does not yet exist one will be created.
                            -Please note a "-" can be used in place of a file name to output
                             to standard out.
